...
if (count($argv) < 3) {
    echo "Usage: show-post-for-another-entity-authenticated.php [entity] [id] [version]\n";
    exit;
}
...
$post = $client->authenticate($auth)->posts()->getEntityPost($server, $entityUri, $id, $version);
